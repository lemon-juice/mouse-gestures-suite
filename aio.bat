...
del "D:\dev\aio-gestures\mouse-gestures-suite-1.0.4.xpi" 2>nul
"C:\Program Files\7-Zip\7z.exe" a -tzip "D:\dev\aio-gestures\mouse-gestures-suite-1.0.4.xpi" "D:\dev\aio-gestures-build\*"
