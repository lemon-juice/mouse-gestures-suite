...
del "D:\dev\aio-gestures\all_in_one_gestures-0.26.5-seamonkey.xpi" 2>nul
"C:\Program Files\7-Zip\7z.exe" a -tzip "D:\dev\aio-gestures\all_in_one_gestures-0.26.5-seamonkey.xpi" "D:\dev\aio-gestures-build\*"
